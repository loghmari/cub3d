...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/11/06 01:32:42 by memam             #+#    #+#             */
/*   Updated: 2022/12/30 15:37:20 by sloghmar         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../includes/cub3d.h"

static void	draw_player(t_param *map, int x, int y, int color)
{
	int	i;
	int	j;
...
static void	draw_pixel(t_param *map, int x, int y, int color)
{
	int	i;
	int	j;
